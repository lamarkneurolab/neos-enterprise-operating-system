...
| 2026-06-26 | SIM-NEOS-F3-012 | Runtime Controlled Activation Gate & Execution Authorization Layer v0.1.0 | BLOCKED | medium | Activation request framework ready for PR review; execution not authorized | PREFLIGHT-NEOS-F3-012 | TEST-EVD-NEOS-F3-012 | AUD-NEOS-F3-012 | SIM-RB-NEOS-F3-012 | SIM-INC-NEOS-F3-012 | Open PR, keep unmerged until explicit authorization |
