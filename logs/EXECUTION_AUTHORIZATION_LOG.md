...
| Date | Authorization ID | Request ID | Authorizer | Scope | PR | Branch | Head SHA | Commit | Action | Decision | Expiration/Limit | Audit | Notes |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| 2026-06-26 | EXEC-AUTH-NEOS-F3-012 | ACT-REQ-NEOS-F3-012 | Tiziano | Block 12 implementation only | pending PR | feature/runtime-controlled-activation-gate-execution-authorization-layer-v0.1.0 | pending commit | pending commit | create branch, Markdown files, commit, push and PR | implementation_only | No merge or execution authorization | AUD-NEOS-F3-012 | Authorization does not permit merge or activation. |
