...
| 2026-06-26 | DRY-RUN-NEOS-F3-012 | Runtime Controlled Activation Gate & Execution Authorization Layer v0.1.0 | not_run | BLOCKED | TEST-EVD-NEOS-F3-012 | AUD-NEOS-F3-012 | SIM-RB-NEOS-F3-011 | SIM-INC-NEOS-F3-011 | Codex / NEOS Runtime Governance | Dry-run result may feed activation request review, but does not authorize execution. |
