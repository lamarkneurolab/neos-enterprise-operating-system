...
| RRV-NEOS-F3-013 | 2026-06-26 | runtime-controlled-execution-activation-protocol | Release readiness validation for Block 13 PR | ready_with_notes | TEST-EVD-NEOS-F3-013 | AUD-NEOS-F3-013 | Codex / NEOS Runtime Governance | Ready for PR review after Markdown validation, commit and push | Keep PR unmerged pending ChatGPT review and explicit Tiziano authorization for the specific PR | Status is documentary release readiness only, not runtime activation, execution approval or merge approval. |
