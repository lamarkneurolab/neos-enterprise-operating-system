...
| VAL-NEOS-F3-013 | 2026-06-26 | runtime-controlled-execution-activation-protocol | Validate Block 13 documentary scope and required files | passed | TEST-EVD-NEOS-F3-013 | AUD-NEOS-F3-013 | Codex / NEOS Runtime Governance | Block 13 activation protocol documented for PR review | Run Markdown validation and `git diff --check`; keep PR unmerged | Validation is documentary and does not activate runtime or execute future runtime work. |
